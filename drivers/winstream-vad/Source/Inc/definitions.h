...
// Product Id — frozen WinStream VAD contract
// {E10CDFCF-3C10-45DE-B4B7-89DE1C73E15B}
#define STATIC_PID_SIMPLEAUDIOSAMPLE\
    0xe10cdfcf, 0x3c10, 0x45de, 0xb4, 0xb7, 0x89, 0xde, 0x1c, 0x73, 0xe1, 0x5b
DEFINE_GUIDSTRUCT("E10CDFCF-3C10-45DE-B4B7-89DE1C73E15B", PID_SIMPLEAUDIOSAMPLE);
#define PID_SIMPLEAUDIOSAMPLE DEFINE_GUIDNAMED(PID_SIMPLEAUDIOSAMPLE)

// Pool tag used for SIMPLEAUDIOSAMPLE allocations
#define SIMPLEAUDIOSAMPLE_POOLTAG               'VSWA'  

// Debug module name
#define STR_MODULENAME              "WINSTREAMVAD: "
